...
/*
1. Constructor y Gestión de Estado Inicial
El constructor es el corazón de la ventana, ya que prepara el entorno según el vehículo seleccionado:

Parámetros de entrada: Recibe un id y un tipo (Automóvil o Camioneta). Esto permite que la ventana sepa exactamente qué registro buscar y qué catálogo de modelos mostrar.

configurarModelosSegunTipo(): Se ejecuta antes de cargar los datos para asegurar que el JComboBox de modelos contenga las opciones correctas de la marca BAIC (como el U5 Plus o la X55 II) según la categoría.

cargarDatos(id): Es un paso crítico. Utiliza la controladora para traer el objeto Vehiculo desde la base de datos y mapear sus atributos a los componentes visuales (textos y combos).

2. Sincronización de Datos (cargarDatos)
Este método realiza el puente entre el objeto persistido y la interfaz:

Recuperación: Invoca a control.traerVehiculo(id), almacenando el objeto completo en la variable de instancia this.vehiculo.

Mapeo Visual: Utiliza los métodos getter del objeto para rellenar los campos. Por ejemplo, boxColor.setSelectedItem(vehiculo.getColor()) busca automáticamente el color coincidente en el combo box.

3. Lógica de Actualización (btnGuardarActionPerformed)
Cuando el usuario presiona Modificar, el sistema no crea un objeto nuevo, sino que actualiza el que ya está en memoria:

Recolección: Captura todos los valores actuales de la interfaz (incluso los que no fueron modificados).

Actualización en Capas: Envía el objeto vehiculo original junto con los nuevos parámetros a la Controladora. Al conservar la instancia original, JPA identifica el ID y realiza una sentencia UPDATE en SQL en lugar de un INSERT.

Feedback Dinámico: Informa el éxito de la operación mencionando el tipo de vehículo modificado (tipoFiltro).

4. Estética y Validación Profesional
personalizarCombos(): Aplica una identidad visual coherente con la marca, utilizando bordes delgados y una paleta de colores limpia. Incluye un Renderer personalizado para que las listas desplegables mantengan un diseño elegante y profesional.

txtCantidadDisponibleKeyTyped: Implementa una restricción a nivel de teclado. Solo permite caracteres numéricos, bloqueando cualquier entrada de texto para evitar errores de formato antes de que los datos lleguen a la lógica de persistencia.

Look and Feel: Al heredar de JFrame y tener el setResizable(false), se asegura que el diseño visual de los paneles (superior, formulario y botones) se mantenga intacto sin importar la resolución del monitor.


*/

public class EditarVehiculo_IGU extends javax.swing.JFrame {
    ...
    public EditarVehiculo_IGU(int id, String tipo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Concesionaria BAIC: Edición");
        ...
        boxModelo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "baic-u5-plus", "baic-eu5" }));
        ...
        boxColor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Silver", "Rojo", "Blanco" }));
        ...
        boxOpcCompra.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Usado", "0KM", "Plan ahorro", "Financiación BAIC" }));
        ...
        boxPantTactil.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "No", "´9´", "´10´", "Fallada" }));
        ...
        boxCantPuertas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "2", "4" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        // 1. Recolectamos los nuevos datos de los ComboBox y campos de texto
        ...
        // 2. Llamamos al método de la controladora pasando el objeto original y los nuevos valores
        // Nota: Usamos el objeto 'vehiculo' que cargamos previamente en cargarDatos()
        control.editarVehiculo(vehiculo, modelo, color, motor, cantidad_disponible,
                cantidad_puertas, opcion_compra, pantalla_tactil, camara_trasera);

        // 3. Mensaje de éxito dinámico usando tipoFiltro
        mostrarMensaje(tipoFiltro + " modificado correctamente.", "Info", "Modificado exitosamente");
    ...
    private void cargarDatos(int id) {
        ...
        this.vehiculo = control.traerVehiculo(id);

        boxModelo.setSelectedItem(vehiculo.getModelo());
        boxColor.setSelectedItem(vehiculo.getColor());
        boxMotor.setSelectedItem(vehiculo.getMotor());
        txtCantidadDisponible.setText(String.valueOf(vehiculo.getCantidad_disponible()));
        boxCantPuertas.setSelectedItem(String.valueOf(vehiculo.getCantidad_puertas()));
        boxOpcCompra.setSelectedItem(vehiculo.getOpcion_compra());
        boxPantTactil.setSelectedItem(vehiculo.getPantalla_tactil());
        boxCamTrasera.setSelectedItem(vehiculo.getCamara_trasera());
    ...
    private void personalizarCombos() {
        ...
        for (javax.swing.JComponent c : componentes) {
            ...
            // 5. IMPORTANTE: NO usamos setUI(new BasicComboBoxUI)
            ...
            if (c instanceof javax.swing.JComboBox) {
                ...
                cb.setRenderer(new javax.swing.plaf.basic.BasicComboBoxRenderer() {
                    ...
                    public java.awt.Component getListCellRendererComponent(javax.swing.JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                        ...
                        if (isSelected) {
                            //setBackground(new java.awt.Color(180, 190, 210)); // Azul grisáceo al seleccionar//no es un buen estilo
